...
<body>
           ...
           ?>
                    ...
                    <form action="" id="signup" style="display: none;" method="POST">
                        <div class="modal-header">
                        ...
                        <div class="d-grid gap-2 col-12 mx-auto">
                            <button type="submit" name="signup" class="btn-lg btn btn-outline-success">Singup</button>
...
if(!$conn){
   die("sorry u are not connect with database:".mysqli_connect_error());
}
else
{
...
$registrationmobile=$_POST['registrationmobile'];
$gender=$_POST['gender'];
$registrationpincode=$_POST['registrationpincode'];
$registrationaddress=$_POST['registrationaddress'];
$registrationpassword=password_hash($_POST['registrationpassword'],PASSWORD_DEFAULT);


$data="INSERT INTO `register`( `registrationname`, `registrationmobile`, `gender`, `registrationpincode`, `registrationaddress`, `registrationpassword`) VALUES ('$registrationname','$registrationmobile','$gender','$registrationpincode','$registrationaddress','$registrationpassword') ";
...
<!-- it is a compare of number and password -->
                    ...
                    // if ($_SERVER["REQUEST_METHOD"] == "POST" && isset ($_POST['login'])) {
                        ...
                        $loginmobile_check_query = "SELECT * FROM register WHERE registrationmobile='$loginmobile'";
                        $result = mysqli_query($conn, $loginmobile_check_query);
                        if (mysqli_num_rows($result)==1) {
                         $user_row = mysqli_fetch_assoc($result);                           
                         if (password_verify($loginpassword, $user_row['registrationpassword'])) {
                            echo "<div class='alert alert-success' role='alert'>Login successful!</div>";
                            $_SESSION['mobile']=$loginmobile;
                                ?>
                                <script>
                            ...
                            echo "<div class='alert alert-danger' role='alert'>Mobile number not registered!</div>";
                        }
                    }
...
<!-- https://github.com/jankikansagra03/btech -->
